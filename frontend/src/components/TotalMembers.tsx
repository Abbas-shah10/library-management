      ...
      <div className="bg-white dark:bg-gray-900 rounded-xl p-5 border border-gray-200 dark:border-gray-800 hover:border-gray-300 dark:hover:border-gray-700 transition">
        ...
        <div className="grid grid-cols-2 gap-3 text-sm mb-4">
          <div className="bg-gray-100 dark:bg-gray-800 rounded-lg p-3">
            ...
            <p className="text-gray-900 dark:text-white font-bold text-lg mt-1">{student}</p>
          </div>
          <div className="bg-gray-100 dark:bg-gray-800 rounded-lg p-3">
            <div className="flex items-center gap-2">
            ...
            <p className="text-gray-900 dark:text-white font-bold text-lg mt-1">{faculty}</p>
          </div>
          <div className="bg-gray-100 dark:bg-gray-800 rounded-lg p-3">
            <div className="flex items-center gap-2">
            ...
            <p className="text-gray-900 dark:text-white font-bold text-lg mt-1">{pub}</p>
          </div>
          <div className="bg-gray-100 dark:bg-gray-800 rounded-lg p-3">
            <div className="flex items-center gap-2">
            ...
            <p className="text-gray-900 dark:text-white font-bold text-lg mt-1">{activeMembers}</p>
          </div>
        </div>
