      ...
      <div className="bg-white dark:bg-gray-900 rounded-xl p-5 border border-gray-200 dark:border-gray-800 hover:border-gray-300 dark:hover:border-gray-700 transition">
        ...
        <div className="grid grid-cols-2 gap-3 text-sm mb-4">
          <div className="bg-gray-100 dark:bg-gray-800 rounded-lg p-3">
            ...
            <p className="text-gray-900 dark:text-white font-bold text-lg mt-1">{admins}</p>
          </div>
          <div className="bg-gray-100 dark:bg-gray-800 rounded-lg p-3">
            <div className="flex items-center gap-2">
              <div className="w-2 h-2 rounded-full bg-amber-400" />
              <span className="text-gray-500 dark:text-gray-400">Librarian</span>
            </div>
            <p className="text-gray-900 dark:text-white font-bold text-lg mt-1">{librarians}</p>
          </div>
          <div className="bg-gray-100 dark:bg-gray-800 rounded-lg p-3">
            <div className="flex items-center gap-2">
            ...
            <p className="text-gray-900 dark:text-white font-bold text-lg mt-1">{activeUsers}</p>
          </div>
          <div className="bg-gray-100 dark:bg-gray-800 rounded-lg p-3">
            <div className="flex items-center gap-2">
        ...
        <p className="text-xs text-gray-500 dark:text-gray-400 mt-2">{pct}% of users are active</p>
      </div>
    </Link>
  );
};
